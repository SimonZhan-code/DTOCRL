...
from utils.dataset_env import make_delay_buffer_adroit_env, make_replay_buffer_adroit_env
...
class DTOCRL():
    def __init__(self, config):
        ...
        self.belief_buffer, self.env = make_delay_buffer_adroit_env(config['env_name'], config['delay'], config['batch_size'])
        ...
        self.replay_buffer, _ = make_replay_buffer_adroit_env(config['env_name'], config['batch_size'])
