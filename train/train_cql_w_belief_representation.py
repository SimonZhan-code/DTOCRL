...
from utils.dataset_env import make_delay_buffer_env, make_replay_buffer_env
...
class DTOCRL():
    def __init__(self, config):
        ...
        self.belief_buffer, self.env = make_delay_buffer_env(config['env_name'], config['delay'], config['batch_size'])
        ...
        self.replay_buffer, _ = make_replay_buffer_env(config['env_name'], config['batch_size'])
    ...
    def train(self, real_batch, synthetic_batch):
        ...
        obss, actions, next_obss, rewards, dones = mix_batch["observations"], mix_batch["actions"], \
